...
<!-- 
	...
	Projekt
		Installer - En bugg i CRequest gör att en kontrollers namn ej kan börja med i n d e x, eftersom den jämför URL'en bokstav för bokstav
					för att avgöra var själva kontroller-delen i URL'en börjar. Och då jämför den troligen med .../index.php. Så om man har en
					kontroller som börjar på "in", t.ex. "installer", så kommer CRequest tro att kontrollern heter "staller"...
