...
function create_url($urlOrController=null, $method=null, $arguments=null) {
  return CNexus::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
...
function theme_url($url) {
  return create_url(CNexus::Instance()->themeUrl . "/{$url}");
}
...
function theme_parent_url($url) {
  return create_url(CNexus::Instance()->themeParentUrl . "/{$url}");
}
...
function render_views($region='default') {
  return CNexus::Instance()->views->Render($region);
}
...
function region_has_content($region='default' /*...*/) {
  return CNexus::Instance()->views->RegionHasView(func_get_args());
}
