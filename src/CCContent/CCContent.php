...
class CCContent extends CObject implements IController {
  ...
  /**
   * Show a listing of all content from a specific user.
   */
  public function User($idUser) {
    ...
    $this->views->SetTitle('Content listing')
                ->AddInclude(__DIR__ . '/index.tpl.php', array(
                  'contents' => $content->ListAll(array('idUser'=>$idUser, 'order-by'=>'title', 'order-order'=>'DESC')),
                ));
  }
