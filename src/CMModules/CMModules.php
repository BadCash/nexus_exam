<?php
/**
 * A model for managing Nexus modules.
 * 
 * @package NexusCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $nexusCoreModules = array('CNexus', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $nexusCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isNexusCore']   = in_array($rc->name, $this->nexusCoreModules);
      $details['isNexusCMF']    = in_array($rc->name, $this->nexusCMFModules);
